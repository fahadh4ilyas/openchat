...
def create_dataset(args, split_name: str) -> NumpyDataset:
    ...
    if not os.path.isfile(filename + ".parquet") or not os.path.isfile(filename + ".pickle") or not os.path.isfile(filename + "part000.parquet") or not os.path.isfile(filename + "part000.pickle"):
