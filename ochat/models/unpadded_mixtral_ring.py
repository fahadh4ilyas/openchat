...
class MixtralForCausalLM(UnpaddedMixtralPreTrainedModel):
    ...
    def forward(
        ...
        if nz_shifted_label_ids is not None:
            ...
            loss = (weighted_cross_entropy(logits, nz_shifted_label_ids, nz_shifted_loss_weights) / total_seqs + self.router_aux_loss_coef * aux_loss, self.router_aux_loss_coef * aux_loss)
