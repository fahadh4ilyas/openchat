...
from ochat.config.conversation_template import Conversation, PretokenizedConversation, ConversationTemplate, ChatMLConversationTemplate
import ochat.models
...
MODEL_CONFIG_MAP = {
    ...
    "llamaRing": ModelConfig(
        ...
        model_tokenizer_create=partial(transformers.AutoTokenizer.from_pretrained,
                                       use_fast=False),
        model_create_for_training=partial(ochat.models.LlamaRingForCausalLM.from_pretrained,
                                          torch_dtype=torch.bfloat16),
    ...
    "llama3.1Ring": ModelConfig(
        ...
        model_tokenizer_create=partial(transformers.AutoTokenizer.from_pretrained,
                                       use_fast=False),
        model_create_for_training=partial(ochat.models.LlamaLongRingForCausalLM.from_pretrained,
                                          torch_dtype=torch.bfloat16),
    ...
    "mistralRing": ModelConfig(
        ...
        model_tokenizer_create=partial(transformers.AutoTokenizer.from_pretrained,
                                       use_fast=False),  # Mistral use legacy=True https://huggingface.co/mistralai/Mistral-7B-v0.1/blob/main/tokenizer_config.json
        model_create_for_training=partial(ochat.models.MistralRingForCausalLM.from_pretrained,
                                          torch_dtype=torch.bfloat16),
    ...
    "mixtralRing": ModelConfig(
        ...
        model_tokenizer_create=partial(transformers.AutoTokenizer.from_pretrained,
                                       use_fast=False),  # Mistral use legacy=True https://huggingface.co/mistralai/Mistral-7B-v0.1/blob/main/tokenizer_config.json
        model_create_for_training=partial(ochat.models.MixtralRingForCausalLM.from_pretrained,
                                          torch_dtype=torch.bfloat16),
    ...
    "qwen2Ring": ModelConfig(
        ...
        model_tokenizer_create=partial(transformers.AutoTokenizer.from_pretrained,
                                       use_fast=False),  # Mistral use legacy=True https://huggingface.co/mistralai/Mistral-7B-v0.1/blob/main/tokenizer_config.json
        model_create_for_training=partial(ochat.models.Qwen2RingForCausalLM.from_pretrained,
                                          torch_dtype=torch.bfloat16),
